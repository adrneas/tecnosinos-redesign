...
- The Tecnosinos indicators count up once when their section becomes visible, preserving their exact Portuguese prefixes, suffixes, and thousands formatting.
...
- “Trabalhar no Tecnosinos” and every “Vagas no Tecnosinos” entry point lead to the searchable internal route `/vagas`, instead of anchoring back to the home-page careers section.
...
- The home-page Internationalization video uses a damped, eased scroll scrub over a three-viewport section; start its fade-in after the section occupies the bottom 30% of the viewport, render it at 70% of the stage size, reveal the content only after the video fade-in, and hold both the content and the video's final frame through the end.
